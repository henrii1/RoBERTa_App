...
import onnxruntime                                # onnxruntime accelerates the execution of models.
...
@app.route("/")
def home():
    return "<h2>RoBERTa sentiment analysis</h2>"   # we can link an entire static page with both Flask and FastAPI
